...
import com.erlei.gdx.graphics.g3d.particles.ParticleSorter;
import com.erlei.gdx.graphics.g3d.particles.renderers.ParticleControllerRenderData;
...
public abstract class BufferedParticleBatch<T extends ParticleControllerRenderData> implements ParticleBatch<T> {
	...
	protected BufferedParticleBatch (Class<T> type) {
		...
		renderData = new com.erlei.gdx.utils.Array<T>(false, 10, type);
	}
