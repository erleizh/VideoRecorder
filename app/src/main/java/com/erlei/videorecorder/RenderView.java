...
public interface RenderView {
    ...
    class GLThread extends Thread {
         ...
         */
        private WeakReference<RenderView> mRenderViewWeakRef;
        private EglCore mEglCore;
        private EglSurfaceBase mWindowSurface;

        GLThread(RenderView renderView) {
            super();
            mWidth = 0;
            mHeight = 0;
            mRequestRender = true;
            ...
            mRenderViewWeakRef = new WeakReference<>(renderView);
        }
                    ...
                    synchronized (sGLThreadManager) {
                        while (true) {
                            ...
                            if (pausing && mHaveEglContext) {
                                RenderView view = mRenderViewWeakRef.get();
