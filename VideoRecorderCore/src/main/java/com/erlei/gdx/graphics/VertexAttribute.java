...
import com.erlei.gdx.graphics.g2d.Mesh;
import com.erlei.gdx.graphics.g2d.ShaderProgram;
...
public final class VertexAttribute {
    /**
     * The attribute {@link VertexAttributes.Usage}, used for identification.
     **/
    ...
    public VertexAttribute(int usage, int numComponents, String alias, int unit) {
        this(usage, numComponents, usage == Usage.ColorPacked ? GLES20.GL_UNSIGNED_BYTE : GLES20.GL_FLOAT,
     ...
     * @param numComponents the number of components of this attribute, must be between 1 and 4.
     * @param type          the OpenGL type of each component, e.g. {@link GLES20#GL_FLOAT} or {@link GLES20#GL_UNSIGNED_BYTE}. Since {@link Mesh}
    ...
    public static VertexAttribute ColorPacked() {
        return new VertexAttribute(Usage.ColorPacked, 4, GLES20.GL_UNSIGNED_BYTE, true, ShaderProgram.COLOR_ATTRIBUTE);
    }

    public static VertexAttribute ColorUnpacked() {
        return new VertexAttribute(Usage.ColorUnpacked, 4, GLES20.GL_FLOAT, false, ShaderProgram.COLOR_ATTRIBUTE);
    }
