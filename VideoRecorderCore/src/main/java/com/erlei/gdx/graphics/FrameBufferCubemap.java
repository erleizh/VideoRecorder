...
public class FrameBufferCubemap extends GLFrameBuffer<Cubemap> {
	 ...
	 * @throws com.erlei.gdx.utils.GdxRuntimeException in case the FrameBuffer could not be created */
	...
	protected void bindSide (final Cubemap.CubemapSide side) {
		GLES30.glFramebufferTexture2D(GLES20.GL_FRAMEBUFFER, GLES20.GL_COLOR_ATTACHMENT0, side.glEnum, getColorBufferTexture().getTextureObjectHandle(), 0);
	}
