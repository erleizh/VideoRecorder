...
public class WindowSurface extends EglSurfaceBase {
     ...
     */
    public WindowSurface(EglCore eglCore, Object surface, boolean releaseSurface) {
        super(eglCore);
    ...
    public WindowSurface(OffscreenSurface windowSurface) {
        super(windowSurface.mEglCore);
