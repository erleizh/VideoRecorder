...
public class ShaderProgram implements Disposable {
    ...
    public ShaderProgram(String vertexShader, String fragmentShader) {
        ...
        if (isCompiled()) {
            fetchAttributes();
            fetchUniforms();
            addManagedShader(Config.app, this);
        }
    }
...
// }
     ...
     * @param type      the type, must be one of GLES20.GL_BYTE, GLES20.GL_UNSIGNED_BYTE, GLES20.GL_SHORT,
     *                  GLES20.GL_UNSIGNED_SHORT,GLES20.GL_FIXED, or GLES20.GL_FLOAT. GL_FIXED will not work on the desktop
     ...
     * @param normalize whether fixed point data should be normalized. Will not work on the desktop
     * @param stride    the stride in bytes between successive attributes
     * @param offset    byte offset into the vertex buffer object bound to GLES20.GL_ARRAY_BUFFER.
     */
    ...
    public void dispose() {
        ...
        if (shaders.get(Config.app) != null) shaders.get(Config.app).removeValue(this, true);
    }
    ...
    public static int getNumManagedShaderPrograms() {
        return shaders.get(Config.app).size;
    }
