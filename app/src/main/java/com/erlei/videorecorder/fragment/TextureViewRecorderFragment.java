 ...
 * 是用TextureView 预览
 */
public class TextureViewRecorderFragment extends Fragment implements SettingsDialogFragment.CameraControllerView {
    ...
    public static TextureViewRecorderFragment newInstance() {
        TextureViewRecorderFragment fragment = new TextureViewRecorderFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_textureview_recorder, container, false);
    }
