...
public class Texture extends GLTexture {
    ...
    public Texture(TextureData data) {
        this(GLES20.GL_TEXTURE_2D, GLUtil.glGenTexture(), data);
    }

    protected Texture(int glTarget, int glHandle, TextureData data) {
        super(glTarget, glHandle);
        load(data);
        if (data.isManaged()) addManagedTexture(Config.app, this);
    }
    ...
    public void draw(Pixmap pixmap, int x, int y) {
        ...
        bind();
        GLES20.glTexSubImage2D(glTarget, 0, x, y, pixmap.getWidth(), pixmap.getHeight(), pixmap.getGLFormat(), pixmap.getGLType(),
                pixmap.getPixels());
    }
        ...
        if (assetManager == null) {
            ...
            for (Texture texture : textures) {
                ...
                if (fileName == null) {
                    ...
                    texture.glHandle = GLUtil.glGenTexture();
