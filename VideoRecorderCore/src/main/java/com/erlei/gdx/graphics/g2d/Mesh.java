...
import com.erlei.gdx.graphics.IndexArray;
import com.erlei.gdx.graphics.IndexBufferObject;
import com.erlei.gdx.graphics.IndexBufferObjectSubData;
import com.erlei.gdx.graphics.IndexData;
import com.erlei.gdx.graphics.VertexArray;
import com.erlei.gdx.graphics.VertexAttribute;
import com.erlei.gdx.graphics.VertexAttributes;
import com.erlei.gdx.graphics.VertexBufferObject;
import com.erlei.gdx.graphics.VertexBufferObjectSubData;
import com.erlei.gdx.graphics.VertexBufferObjectWithVAO;
import com.erlei.gdx.graphics.VertexData;
import com.erlei.gdx.math.BoundingBox;
...
public class Mesh implements Disposable {
    ...
    protected Mesh(VertexData vertices, IndexData indices, boolean isVertexArray) {
        ...
        addManagedMesh(Config.app, this);
    }
     ...
     */
    public void dispose() {
        if (meshes.get(Config.app) != null) meshes.get(Config.app).removeValue(this, true);
        vertices.dispose();
        indices.dispose();
    }
