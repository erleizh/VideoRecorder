...
public class AndroidFiles implements Files {
    ...
    private static final AndroidFiles ourInstance = new AndroidFiles(Config.app.getAssets(), Config.app.getFilesDir().getAbsolutePath());
    ...
    public boolean setAPKExpansion(int mainVersion, int patchVersion) {
        try {
            expansionFile = APKExpansionSupport.getAPKExpansionZipFile(
                    Config.app.getApplicationContext(),
