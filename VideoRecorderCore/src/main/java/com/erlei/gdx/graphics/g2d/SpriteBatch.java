...
public class SpriteBatch implements Batch {
     ...
     *
     * @see SpriteBatch#SpriteBatch(int, ShaderProgram, Size)
     */
    public SpriteBatch(Size screenSize) {
        this(1000, null, screenSize);
    }
     ...
     * @see SpriteBatch#SpriteBatch(int, ShaderProgram, Size)
     */
    public SpriteBatch(int size, Size screenSize) {
        this(size, null, screenSize);
    }
     ...
     */
    public SpriteBatch(int size, ShaderProgram defaultShader, Size screenSize) {
        // 32767 is max vertex index, so 32767 / 4 vertices per sprite = 8191 sprites max.
        if (size > 8191)
            throw new IllegalArgumentException("Can't have more than 8191 sprites per batch: " + size);

        Mesh.VertexDataType vertexDataType = (GLUtil.GL_VERSION >= 3) ? Mesh.VertexDataType.VertexBufferObjectWithVAO : defaultVertexDataType;
        ...
        projectionMatrix.setToOrtho2D(0, 0, screenSize.getWidth(), screenSize.getHeight());
    ...
    public void end() {
        ...
        if (isBlendingEnabled()) GLES20.glDisable(GLES20.GL_BLEND);
    ...
    public void flush() {
        ...
        if (blendingDisabled) {
            ...
            if (blendSrcFunc != -1)
                GLES20.glBlendFuncSeparate(blendSrcFunc, blendDstFunc, blendSrcFuncAlpha, blendDstFuncAlpha);
        }

        mesh.render(customShader != null ? customShader : shader, GLES20.GL_TRIANGLES, 0, count);
