 ...
 * {@link ModelBatch#begin(com.erlei.gdx.graphics.Camera)} and {@link ModelBatch#end()}. Therefor Renderable instances cannot
...
public class Renderable {
	 ...
	 * {@link com.erlei.gdx.graphics.VertexAttributes.Usage#BoneWeight} vertex attributes, then the BoneWeight index is used as
