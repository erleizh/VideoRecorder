...
import com.erlei.gdx.files.assets.CubemapLoader;
...
public class Cubemap extends GLTexture {
    ...
    public void load(CubemapData data) {
        ...
        GLES30.glBindTexture(glTarget, 0);
    }
    ...
    public void dispose() {
        ...
        delete();
        if (data.isManaged()) if (managedCubemaps.get(Config.app) != null)
            managedCubemaps.get(Config.app).removeValue(this, true);
    }
        ...
        if (assetManager == null) {
            ...
            for (Cubemap cubemap : cubemaps) {
                ...
                if (fileName == null) {
                    ...
                    cubemap.glHandle = GLUtil.glGenTexture();
    ...
    public static int getNumManagedCubemaps() {
        return managedCubemaps.get(Config.app).size;
    }
