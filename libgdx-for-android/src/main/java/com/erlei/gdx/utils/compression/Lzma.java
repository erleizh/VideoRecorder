...
package com.erlei.gdx.utils.compression;
...
public class Lzma {
	...
	static public void compress (InputStream in, OutputStream out) throws IOException {
		...
		com.erlei.gdx.utils.compression.lzma.Encoder encoder = new com.erlei.gdx.utils.compression.lzma.Encoder();
	...
	static public void decompress (InputStream in, OutputStream out) throws IOException {
		...
		com.erlei.gdx.utils.compression.lzma.Decoder decoder = new com.erlei.gdx.utils.compression.lzma.Decoder();
