...
public class Decoder {
	class LenDecoder {
		...
		public void Init () {
			com.erlei.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_Choice);
		...
		public int Decode (com.erlei.gdx.utils.compression.rangecoder.Decoder rangeDecoder, int posState) throws IOException {
	...
	class LiteralDecoder {
		class Decoder2 {
			...
			public void Init () {
				com.erlei.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_Decoders);
			}

			public byte DecodeNormal (com.erlei.gdx.utils.compression.rangecoder.Decoder rangeDecoder) throws IOException {
				int symbol = 1;
				do
			...
			public byte DecodeWithMatchByte (com.erlei.gdx.utils.compression.rangecoder.Decoder rangeDecoder, byte matchByte)
				throws IOException {
				int symbol = 1;
				do {
	...
	com.erlei.gdx.utils.compression.rangecoder.Decoder m_RangeDecoder = new com.erlei.gdx.utils.compression.rangecoder.Decoder();
	...
	void Init () throws IOException {
		...
		com.erlei.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_IsMatchDecoders);
		com.erlei.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRep0LongDecoders);
		com.erlei.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepDecoders);
		com.erlei.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG0Decoders);
		com.erlei.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG1Decoders);
		com.erlei.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG2Decoders);
		com.erlei.gdx.utils.compression.rangecoder.Decoder.InitBitModels(m_PosDecoders);
